...
jQuery(document).ready(function () {
  ...
  jQuery('.main_product_tab li').bind('click', function () {
    ...
    jQuery('button', this).parent('li').addClass('active');
  ...
  jQuery('.main_product_category .main_product_inner .main_product_tab li:first-child').addClass('active');
    ...
    function _reset(section, type) {
      ...
      jQuery(section)
        ...
        .each(function () {
          ...
          if (!document.documentElement.classList.contains('ez-view-type-mobile') && grid_num > li_num) {
            // 모바일일때
