...
jQuery(document).ready(function () {
  ...
  jQuery('#ec-product-searchdata-searchkeyword_form')
...
function ifmore() {
  ...
  //       jQuery(this).children('.heart-icon').addClass('checked'); // 하트아이콘
  //     }
  //   });
  ...
  //     } else {
  //       jQuery(this).removeClass('on');
  //       jQuery(this).children('.heart-icon').removeClass('checked'); // 하트아이콘
  //     }
  //   });
  // }, 200);
